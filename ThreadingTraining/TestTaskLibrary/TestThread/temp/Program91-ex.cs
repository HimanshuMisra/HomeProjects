...
//An orderable (and Contextual) Partitioner
namespace TestThread
{
    ...
    class Program91
    {
        static void Main91(string[] args)
        {
            ...
            // create the parallel
            Parallel.ForEach(cPartitioner,
            (WorkItem item, ParallelLoopState loopState, long index) =>
            {
            ...
            public IEnumerator<KeyValuePair<long, WorkItem>> GetEnumerator()
            {
                while (true)
                {
                    ...
                    else
                    {
                        ...
                        {
                            yield return new
                            KeyValuePair<long, WorkItem>(i,
                            parentPartitioner.dataItems[i]);
                        }
                    }
                }
            }

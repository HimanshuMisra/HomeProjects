...
namespace TestThread
{
     ...
     * ReaderWriterLock class. The latter is similar in functionality, but it is several times 
     * slower and has an inherent design fault in its mechanism for handling lock upgrades.
    */
    class Program38
    {
        class BankAccount

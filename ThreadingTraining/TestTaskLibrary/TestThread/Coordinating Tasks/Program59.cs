...
//Propagating Exceptions Along a Continuation Chain
namespace TestThread
{
    //By having the continuation process the exceptions thrown by the antecedent, we can catch
    //exceptions thrown by the last Task in the chain and be sure to avoid unhandled exceptions.
    class Program59
    {
        class BankAccount
        {
